...
const setup_TopSortAlsWebApp = () => {
    ...
    var input1 = elementFactory("input", { type: "search", id: "input1" }, "grid-area:input1;");
    var input2 = elementFactory("input", { type: "search", id: "input2" }, "grid-area:input2;");
    let headline = elementFactory("h1", {}, "", "TopSort als Web-App");
    let h1div = elementFactory("div", {}, "");
    h1div.appendChild(headline);
    main_header.appendChild(h1div);
    var resetbutton = elementFactory("button", { id: "resetbutton" }, "height:1.5rem; width:5rem; grid-area:reset;", "reset");
    resetbutton.addEventListener("click", () => setup_TopSortAlsWebApp());
    let button = elementFactory("button", { id: "sortbutton" }, "height:1.5rem; width:5rem; grid-area:sortieren;", "sortieren");
    ...
    let addbutton = elementFactory("button", { id: "addbutton" }, "grid-area:hinzufügen; height:1.5rem; width:5rem;", "hinzufügen");
