...
const setup_TextAnalyse = async () => {
    ...
    let header = elementFactory("div", {}, "", '<h2 class="field field--name-title field--type-ds field--label-hidden">Plagiatsresolution und -maßnahmen</h2>');
    var ergebnisdiv = elementFactory("div", {}, "display:flex; justify-content:space-evenly; flex-wrap:wrap;");
    var analysecontainer = elementFactory("div", { id: "ergebnisdiv" }, "");
    let content = elementFactory("div", { class: "content" }, "");
    ...
    let brschrft = elementFactory("h1", {}, "", "Textanalyse mit filter-map-reduce");
