...
const setup_TextAnalyse=async():Promise<void>=>{
     ...
     let ueberschriftcontainer:HTMLDivElement = document.createElement("div");
     let brschrft:HTMLHeadElement = document.createElement("h1");
     ...
     let filtered:string[]|any[] = stoparray2d.filter(x=>x[1]>=10);
     ...
     let column:HTMLTableCellElement = row.insertCell(0);
     ...
     let reihe:HTMLTableRowElement = table.insertRow(-1);
     let zelle:HTMLTableCellElement = reihe.insertCell(0);
