...
const setup_TextAnalyse=async():Promise<void>=>{
     ...
     let header:HTMLHeadElement = elementFactory("div",{},"",true,'<h2 class="field field--name-title field--type-ds field--label-hidden">Plagiatsresolution und -maßnahmen</h2>');
     ...
     let tabelle:HTMLTableElement = <HTMLTableElement>elementFactory("table",{},"font-size: clamp(0.6em, 4vw, 1.2em);");
     ...
     let table:HTMLTableElement = <HTMLTableElement>elementFactory("table",{},"font-size: clamp(0.6em, 4vw, 1.2em);")
