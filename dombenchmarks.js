...
export function domBenchmarks() {
    ...
    let ueberschrift = elementFactory("h1", { id: "headline" }, "", "Performanz-Messungen von DOM-Operationen");
    var tabelle = elementFactory("table", { id: "benchmarktabelle", class: "tabelle" }, "border:1px solid black;");
    ...
    let codediv = elementFactory("div", {}, "border:1px solid lightgrey; padding:10px; width:500px; background-color:#e7e9eb;", "<b>Codesample</b><br>...<br><code>let t0 = performance.now();</code><br><code>for(i=0;i<500;i++){</code>" + "<br><code>div.innerHTML+=text;}</code><br><code>let t1 = performance.now();</code>" + "<br><code>return t1-t0;</code><br>...");
