...
export const setup_webInventors = () => {
    ...
    const h1 = elementFactory("h1", {}, "", false, "Inventors of the web");
    addBrotkrümel("Startseite", "Inventors of the web");
    //main_header.appendChild(h1);
    main_main.innerHTML = "<h1>Inventors of the web</h1><br><ul><li><b><u><mark>Tim Berners-Lee</mark>:</u></b> WWW,HTTP,HTML,URI</li><li><b>Hakom Lie and Bert Bos:</b> CSS</li><li><b>Brendan Eich:</b> Java Script</li></ul><hr><br>" +
